    ...
    <div class="col-sm-offset-2 col-sm-8">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <!-- New Task Form -->
            <form action="{{ route('postAvatar')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <!-- Task Name -->
                    ...
                    <div class="form-group">
                        <label for="task-name" class="col-sm-3 control-label">Avatar</label>
